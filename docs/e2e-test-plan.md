...
| [docs/e2e/cli-tests.md](e2e/cli-tests.md) | CLI commands: find, fast, grep, index, info, cleanup |
...
| [docs/e2e/mcp-fast-edit-tests.md](e2e/mcp-fast-edit-tests.md) | MCP `xray_fast`, `xray_edit`, `xray_find` |
