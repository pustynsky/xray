...
pub fn parameter_examples(def_extensions: &[String]) -> Value {
    ...
    json!({
        "xray_definitions": {
            ...
            "autoSummary": "Triggered automatically when results > maxResults and no name filter. Returns directory-grouped overview with counts, top-3 definitions, and memberNames (alphabetical list of Parent.Method names, deduped, capped at 50). To get individual definitions instead, add name filter or narrow file scope",
