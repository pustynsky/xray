...
pub use code_xray::{canonicalize_or_warn, clean_path, is_path_within, path_eq, read_file_lossy, tokenize, ContentIndex, FileEntry, FileIndex, Posting, TrigramIndex, DEFAULT_MIN_TOKEN_LEN, FILE_INDEX_VERSION};
